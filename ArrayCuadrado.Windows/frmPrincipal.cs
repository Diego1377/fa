    ...
    public partial class frmPrincipal : Form
    {
        ...
        private void tsbNuevo_Click(object sender, EventArgs e)
        {
            ...
            if (!repo.Existe(cuadrado)) 
            {
                ...
                DataGridViewRow r = ConstruirFilas();
        ...
        private DataGridViewRow ConstruirFilas()
        {
        ...
        private void tsbFiltro_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Filtro Aplicado!!!\nDebe actualizar la grilla", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
